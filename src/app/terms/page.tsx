    ...
    <main className="min-h-dvh bg-black text-white">
      <div className="mx-auto w-full max-w-2xl px-6 py-12 space-y-8">
        ...
        <Section title="4. Subscriptions and Payments">
          ...
          <p className="mt-2">
            Pricing is $3.99 per month or $29.99 per year. We may change pricing
            with reasonable notice. Free trial periods, if offered, convert to
            paid subscriptions unless canceled before the trial ends.
          </p>
        </Section>
